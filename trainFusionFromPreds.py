...
class Solver(object):
    ...
    def __init__(self, config, args):
        ...
        if not os.path.exists(os.path.join(self.exp_dir, 'best_modality_models.pkl')):
            self.get_best_modality_models()
            utils.dump(self.best_modality_models, os.path.join(self.exp_dir, 'best_modality_models.pkl'))
        else:
            self.best_modality_models = utils.load(os.path.join(self.exp_dir, 'best_modality_models.pkl'))
